...
namespace BetaLogistics.Migrations
{
    ...
    [Migration("20240902112214_AddLocationUpdates")]
    partial class AddLocationUpdates
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BetaLogistics.Models.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("BetaLogistics.Models.LocationUpdate", b =>
                {
            ...
            modelBuilder.Entity("BetaLogistics.Models.Shipment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            EstimatedDelivery = new DateTime(2024, 9, 5, 12, 22, 13, 657, DateTimeKind.Local).AddTicks(5412),
                            Origin = "Lagos",
                            Status = "In Transit",
                        ...
                        new
                        {
                            ...
                            CustomerId = 2,
                            Destination = "Lagos",
                            EstimatedDelivery = new DateTime(2024, 8, 31, 12, 22, 13, 657, DateTimeKind.Local).AddTicks(5436),
                            Origin = "Calabar",
                            Status = "Delivered",
                        ...
                        new
                        {
                            ...
                            CustomerId = 3,
                            Destination = "Abuja",
                            EstimatedDelivery = new DateTime(2024, 9, 4, 12, 22, 13, 657, DateTimeKind.Local).AddTicks(5439),
                            Origin = "Lagos",
                            Status = "In Transit",
                            TrackingNumber = "TRK654321",
                            VehicleId = 3
            ...
            modelBuilder.Entity("BetaLogistics.Models.LocationUpdate", b =>
                {
                    b.HasOne("BetaLogistics.Models.Shipment", "Shipment")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("BetaLogistics.Models.ApplicationUser", null)
                        .WithMany()
